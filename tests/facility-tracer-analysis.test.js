...
test("existing facility workflow exposes reporting states, filters and complete export fields", () => {
  ...
  assert.match(appSource, /applyReportingKpiFilter\("district-reported"/);
  assert.match(appSource, /applyReportingKpiFilter\("facility-missing"/);
  assert.match(appSource, /Clear KPI filter/);
